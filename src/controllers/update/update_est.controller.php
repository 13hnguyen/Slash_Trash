<?php
    ...
    else
    {
        ...
        if($query = "UPDATE ESTABLISHMENT SET Address = :Address, Waste_Pts = :Waste_Pts WHERE Est_Id = :Est_Id")
        {
            if($query==null)
            {
            ...
            else
            {
                ...
                $stmt->execute(array(':Est_Id' => $Est_Id, ':Address' => $Est_Address, ':Waste_Pts' => $Waste_Pts));
